...
from utils.functions import gaussian_kld, get_bleu_stats, get_checkpoint_state
...
class Chatbot:
    ...
    def test_epoch(self, limit=5, dest=sys.stdout):
        local_t = 0
        recall_bleus = []
        prec_bleus = []
        repeat = 5
        ...
        while True:
            ...
            if batch_data is None or local_t > limit:
                break
